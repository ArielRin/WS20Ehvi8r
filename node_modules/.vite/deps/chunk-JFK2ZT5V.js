...
var useAffectedDebugValue = (state21, affected) => {
  const pathList = (0, import_react.useRef)();
  (0, import_react.useEffect)(() => {
    pathList.current = w(state21, affected, true);
  });
...
function proxyMap(entries2) {
  const map = proxy({
    ...
    get(key) {
      var _a2;
      return (_a2 = this.data.find((p3) => p3[0] === key)) == null ? void 0 : _a2[1];
    },
    delete(key) {
...
var ApiController = {
  ...
  async fetchWallets({ page }) {
    ...
    state13.wallets = CoreHelperUtil.uniqueBy([...state13.wallets, ...ApiController._filterOutExtensions(data)], "id");
  ...
  async searchWallet({ search }) {
    ...
    state13.search = ApiController._filterOutExtensions(data);
  },
...
var OptionsController = {
  ...
  setIsUniversalProvider(isUniversalProvider) {
    state14.isUniversalProvider = isUniversalProvider;
  },
...
var ConnectorController = {
  ...
  setConnectors(connectors, multiChain) {
    if (multiChain) {
      state15.connectors = [...state15.connectors, ...connectors.map((c2) => ref(c2))];
      state15.connectors = this.mergeMultiChainConnectors(state15.connectors);
    } else {
      state15.connectors = connectors.map((c2) => ref(c2));
    }
  },
  ...
  getAuthConnector() {
    return state15.connectors.find((c2) => c2.type === "AUTH");
  },
  getAnnouncedConnectorRdns() {
    return state15.connectors.filter((c2) => c2.type === "ANNOUNCED").map((c2) => {
      var _a2;
  ...
  getConnector(id, rdns) {
    return state15.connectors.find((c2) => {
      var _a2;
...
buffer/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-JFK2ZT5V.js.map
