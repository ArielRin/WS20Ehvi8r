...
import {
  ...
  ProviderUtil,
  WcConstantsUtil
} from "./chunk-O4HLFQ2L.js";
import "./chunk-3WVNEP6P.js";
import {
  AccountController,
  ChainController,
  ConstantsUtil,
...
// node_modules/@coinbase/wallet-sdk/node_modules/@noble/hashes/_md.js
var require_md = __commonJS({
  "node_modules/@coinbase/wallet-sdk/node_modules/@noble/hashes/_md.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
// node_modules/@coinbase/wallet-sdk/node_modules/@noble/hashes/sha256.js
var require_sha256 = __commonJS({
  "node_modules/@coinbase/wallet-sdk/node_modules/@noble/hashes/sha256.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
var EthersHelpersUtil = {
  getCaipDefaultChain(chain) {
    ...
    return {
      id: `${ConstantsUtil3.EIP155}:${chain.chainId}`,
      name: chain.name,
...
var EthersMethods = {
  ...
  getEnsAddress: async (value, appKit) => {
    var _a;
    try {
      const chainId = Number((_a = appKit.getCaipNetwork()) == null ? void 0 : _a.id);
      let ensName = null;
      let wcName = false;
      if (isReownName(value)) {
        wcName = await (appKit == null ? void 0 : appKit.resolveReownName(value)) || false;
      }
      if (chainId === 1) {
...
var W3mFrameProviderSingleton = class _W3mFrameProviderSingleton {
  ...
  static getInstance(projectId, chainId) {
    if (!_W3mFrameProviderSingleton.instance) {
      _W3mFrameProviderSingleton.instance = new W3mFrameProvider(projectId, chainId);
    }
...
var EthersAdapter = class {
  createEthersConfig(options) {
    ...
    function getCoinbaseProvider() {
      ...
      const coinbaseWallet = new import_wallet_sdk.CoinbaseWalletSDK({
        ...
        appChainIds: ((_c = options.networks) == null ? void 0 : _c.map((caipNetwork) => caipNetwork.chainId)) || [
          1,
          84532
        ]
      });
  ...
  constructor() {
    ...
    this.siweControllerClient = (_a = this.options) == null ? void 0 : _a.siweConfig;
    this.tokens = HelpersUtil.getCaipTokens((_b = this.options) == null ? void 0 : _b.tokens);
    this.defaultCaipNetwork = void 0;
    this.adapterType = "ethers";
    this.providerHandlers = null;
    ChainController.subscribeKey("activeCaipNetwork", (val) => {
      var _a2;
      const caipAddress = (_a2 = this.appKit) == null ? void 0 : _a2.getCaipAddress(this.chainNamespace);
      const isEVMAddress = caipAddress == null ? void 0 : caipAddress.startsWith("eip155:");
      const isEVMNetwork = (val == null ? void 0 : val.chainNamespace) === this.chainNamespace;
    ...
    ChainController.subscribeKey("activeCaipAddress", (val) => {
      const isEVMAddress = val == null ? void 0 : val.startsWith("eip155:");
      const caipNetwork = ChainController.state.activeCaipNetwork;
      const isEVMNetwork = (caipNetwork == null ? void 0 : caipNetwork.chainNamespace) === this.chainNamespace;
      if (isEVMAddress) {
        if (isEVMNetwork) {
    ...
    AccountController.subscribeKey("shouldUpdateToAddress", (newAddress) => {
      const isEVMAddress = newAddress == null ? void 0 : newAddress.startsWith("0x");
      if (isEVMAddress) {
  ...
  construct(appKit, options) {
    ...
    this.networkControllerClient = {
      switchCaipNetwork: async (caipNetwork) => {
        if (caipNetwork == null ? void 0 : caipNetwork.chainId) {
          try {
    ...
    this.connectionControllerClient = {
      connectWalletConnect: async (onUri) => {
        var _a2, _b2, _c2, _d2;
        await ((_d2 = (_c2 = (_b2 = (_a2 = this.appKit) == null ? void 0 : _a2.universalAdapter) == null ? void 0 : _b2.connectionControllerClient) == null ? void 0 : _c2.connectWalletConnect) == null ? void 0 : _d2.call(_c2, onUri));
      },
      connectExternal: async ({ id, info, provider }) => {
        var _a2;
        (_a2 = this.appKit) == null ? void 0 : _a2.setClientId(null);
        const connectorConfig = {
          [ConstantsUtil3.INJECTED_CONNECTOR_ID]: {
            getProvider: () => {
              var _a3;
              return (_a3 = this.ethersConfig) == null ? void 0 : _a3.injected;
            },
            providerType: "injected"
          },
          [ConstantsUtil3.EIP6963_CONNECTOR_ID]: {
            getProvider: () => provider,
            providerType: "eip6963"
          },
          [ConstantsUtil3.COINBASE_SDK_CONNECTOR_ID]: {
            getProvider: () => {
              var _a3;
              return (_a3 = this.ethersConfig) == null ? void 0 : _a3.coinbase;
            },
            providerType: "coinbase"
          },
          [ConstantsUtil3.AUTH_CONNECTOR_ID]: {
        ...
        try {
          if (selectedProvider && id !== ConstantsUtil3.AUTH_CONNECTOR_ID) {
            await selectedProvider.request({ method: "eth_requestAccounts" });
          }
          await this.setProvider(selectedProvider, selectedConnector.providerType, info == null ? void 0 : info.name);
        } catch (error) {
          if (id === ConstantsUtil3.COINBASE_SDK_CONNECTOR_ID) {
      ...
      checkInstalled: (ids) => {
        ...
        if ((_a2 = this.ethersConfig) == null ? void 0 : _a2.injected) {
      ...
      disconnect: async () => {
        ...
        (_a2 = this.appKit) == null ? void 0 : _a2.setClientId(null);
        if ((_d2 = (_c2 = (_b2 = this.options) == null ? void 0 : _b2.siweConfig) == null ? void 0 : _c2.options) == null ? void 0 : _d2.signOutOnDisconnect) {
          const { SIWEController } = await import("./exports-S4LPZMO3.js");
          await SIWEController.signOut();
        }
        const disconnectConfig = {
          [ConstantsUtil3.WALLET_CONNECT_CONNECTOR_ID]: async () => {
            var _a3, _b3, _c3;
            return await ((_c3 = (_b3 = (_a3 = this.appKit) == null ? void 0 : _a3.universalAdapter) == null ? void 0 : _b3.connectionControllerClient) == null ? void 0 : _c3.disconnect());
          },
          coinbaseWalletSDK: async () => {
            var _a3, _b3, _c3;
            return await ((_c3 = (_b3 = (_a3 = this.appKit) == null ? void 0 : _a3.universalAdapter) == null ? void 0 : _b3.connectionControllerClient) == null ? void 0 : _c3.disconnect());
          },
          [ConstantsUtil3.AUTH_CONNECTOR_ID]: async () => {
            var _a3;
            await ((_a3 = this.authProvider) == null ? void 0 : _a3.disconnect());
          },
          [ConstantsUtil3.EIP6963_CONNECTOR_ID]: async () => {
            if (provider) {
              await this.revokeProviderPermissions(provider);
            }
          },
          [ConstantsUtil3.INJECTED_CONNECTOR_ID]: async () => {
            if (provider) {
              ;
        ...
        (_e2 = this.appKit) == null ? void 0 : _e2.resetAccount(this.chainNamespace);
      },
      ...
      estimateGas: async (data) => {
        ...
        const caipAddress = ChainController.state.activeCaipAddress;
        const address = CoreHelperUtil.getPlainAddress(caipAddress);
        const caipNetwork = (_a2 = this.appKit) == null ? void 0 : _a2.getCaipNetwork();
        if (!address) {
          throw new Error("Address is undefined");
        }
        if (!provider) {
        ...
        return await EthersMethods.estimateGas(data, provider, address, Number(caipNetwork == null ? void 0 : caipNetwork.chainId));
      },
      sendTransaction: async (data) => {
        ...
        return await EthersMethods.sendTransaction(data, provider, address, Number(caipNetwork == null ? void 0 : caipNetwork.chainId));
      },
      writeContract: async (data) => {
        ...
        return await EthersMethods.writeContract(data, provider, address, Number(caipNetwork == null ? void 0 : caipNetwork.chainId));
      },
      ...
      getEnsAvatar: async (value) => {
        var _a2;
        const caipNetwork = (_a2 = this.appKit) == null ? void 0 : _a2.getCaipNetwork();
        return await EthersMethods.getEnsAvatar(value, Number(caipNetwork == null ? void 0 : caipNetwork.chainId));
      }
    };
    ...
    (_b = this.appKit) == null ? void 0 : _b.setEIP6963Enabled((_a = this.ethersConfig) == null ? void 0 : _a.EIP6963);
  ...
  subscribeState(callback) {
    var _a;
    return (_a = this.appKit) == null ? void 0 : _a.subscribeState((state) => callback(state));
  }
  async disconnect() {
    var _a;
  ...
  checkActiveProviders(config) {
    ...
    const providerConfigs = {
      ...
      [ConstantsUtil3.EIP6963_CONNECTOR_ID]: {
        provider: (_a = this.EIP6963Providers.find((p3) => p3.info.name === walletName)) == null ? void 0 : _a.provider
      }
    };
    const activeConfig = providerConfigs[walletId];
    if (activeConfig == null ? void 0 : activeConfig.provider) {
  ...
  async setProvider(provider, providerId, name) {
    ...
    if (providerId === "w3mAuth") {
      ...
      if (provider) {
        ...
        const firstAddress = addresses == null ? void 0 : addresses[0];
        const caipAddress = `${this.chainNamespace}:${chainId}:${firstAddress}`;
        if (firstAddress && chainId) {
          (_a = this.appKit) == null ? void 0 : _a.setCaipAddress(caipAddress, this.chainNamespace);
          ProviderUtil.setProviderId("eip155", providerId);
          ProviderUtil.setProvider("eip155", provider);
          (_b = this.appKit) == null ? void 0 : _b.setStatus("connected", this.chainNamespace);
          (_c = this.appKit) == null ? void 0 : _c.setAllAccounts(addresses.map((address) => ({ address, type: "eoa" })), this.chainNamespace);
        }
      }
    }
  }
  async setAuthProvider() {
    ...
    SafeLocalStorage.setItem(SafeLocalStorageKeys.WALLET_ID, ConstantsUtil3.AUTH_CONNECTOR_ID);
    if (this.authProvider) {
      ...
      const { address, chainId, smartAccountDeployed, preferredAccountType, accounts = [] } = await this.authProvider.connect({
        chainId: Number(NetworkUtil.caipNetworkIdToNumber((_c = (_b = this.appKit) == null ? void 0 : _b.getCaipNetwork()) == null ? void 0 : _c.id) ?? ((_d = this.caipNetworks[0]) == null ? void 0 : _d.chainId))
      });
      const { smartAccountEnabledNetworks } = await this.authProvider.getSmartAccountEnabledNetworks();
      (_e = this.appKit) == null ? void 0 : _e.setSmartAccountEnabledNetworks(smartAccountEnabledNetworks, this.chainNamespace);
      if (address && chainId) {
        (_f = this.appKit) == null ? void 0 : _f.setAllAccounts(accounts.length > 0 ? accounts : [{ address, type: preferredAccountType }], this.chainNamespace);
        (_g = this.appKit) == null ? void 0 : _g.setStatus("connected", this.chainNamespace);
        (_h = this.appKit) == null ? void 0 : _h.setCaipAddress(`${this.chainNamespace}:${chainId}:${address}`, this.chainNamespace);
        (_i = this.appKit) == null ? void 0 : _i.setPreferredAccountType(preferredAccountType, this.chainNamespace);
        (_j = this.appKit) == null ? void 0 : _j.setSmartAccountDeployed(Boolean(smartAccountDeployed), this.chainNamespace);
        ProviderUtil.setProvider("eip155", this.authProvider);
        ProviderUtil.setProviderId("eip155", ConstantsUtil3.AUTH_CONNECTOR_ID);
        this.setupProviderListeners(this.authProvider, "w3mAuth");
        this.watchModal();
      }
      (_k = this.appKit) == null ? void 0 : _k.setLoading(false);
    }
  }
  watchModal() {
    if (this.authProvider) {
      this.subscribeState((val) => {
        var _a;
        if (!val.open) {
          (_a = this.authProvider) == null ? void 0 : _a.rejectRpcRequests();
        }
      });
    }
  }
  setupProviderListeners(provider, providerId) {
    ...
    const accountsChangedHandler = (accounts) => {
      var _a, _b, _c, _d;
      const currentAccount = accounts == null ? void 0 : accounts[0];
      if (currentAccount) {
        (_a = this.appKit) == null ? void 0 : _a.setCaipAddress(currentAccount, this.chainNamespace);
        if (providerId === ConstantsUtil3.EIP6963_CONNECTOR_ID) {
          (_b = this.appKit) == null ? void 0 : _b.setAllAccounts(accounts.map((address) => ({ address, type: "eoa" })), this.chainNamespace);
        }
      } else {
        if (providerId === ConstantsUtil3.EIP6963_CONNECTOR_ID) {
          (_c = this.appKit) == null ? void 0 : _c.setAllAccounts([], this.chainNamespace);
        }
        SafeLocalStorage.removeItem(SafeLocalStorageKeys.WALLET_ID);
        (_d = this.appKit) == null ? void 0 : _d.resetAccount(this.chainNamespace);
      }
    };
    const chainChangedHandler = (chainId) => {
      var _a, _b;
      const chainIdNumber = typeof chainId === "string" ? EthersHelpersUtil.hexStringToNumber(chainId) : Number(chainId);
      const caipNetwork = this.caipNetworks.find((c3) => c3.chainId === chainIdNumber);
      const currentCaipNetwork = (_a = this.appKit) == null ? void 0 : _a.getCaipNetwork();
      if (!currentCaipNetwork || (currentCaipNetwork == null ? void 0 : currentCaipNetwork.id) !== (caipNetwork == null ? void 0 : caipNetwork.id)) {
        (_b = this.appKit) == null ? void 0 : _b.setCaipNetwork(caipNetwork);
      }
    };
    if (providerId === ConstantsUtil3.AUTH_CONNECTOR_ID) {
  ...
  setupAuthListeners(authProvider) {
    authProvider.onRpcRequest((request) => {
      ...
      if (W3mFrameHelpers.checkIfRequestExists(request)) {
        if (!W3mFrameHelpers.checkIfRequestIsSafe(request)) {
          (_a = this.appKit) == null ? void 0 : _a.handleUnsafeRPCRequest();
        }
      } else {
    ...
    authProvider.onRpcSuccess((_3, request) => this.handleAuthRpcSuccess(_3, request));
  ...
  handleInvalidAuthRequest() {
    var _a;
    (_a = this.appKit) == null ? void 0 : _a.open();
    setTimeout(() => {
      var _a2;
      (_a2 = this.appKit) == null ? void 0 : _a2.showErrorMessage(W3mFrameRpcConstants.RPC_METHOD_NOT_ALLOWED_UI_MESSAGE);
    }, 300);
  }
  handleAuthRpcError() {
    var _a, _b, _c, _d;
    if ((_a = this.appKit) == null ? void 0 : _a.isOpen()) {
      if ((_b = this.appKit) == null ? void 0 : _b.isTransactionStackEmpty()) {
  ...
  handleAuthRpcSuccess(_3, request) {
    var _a, _b, _c;
    const isSafeRequest = W3mFrameHelpers.checkIfRequestIsSafe(request);
    if (isSafeRequest) {
      return;
    }
    if ((_a = this.appKit) == null ? void 0 : _a.isTransactionStackEmpty()) {
      (_b = this.appKit) == null ? void 0 : _b.close();
    } else {
  ...
  handleAuthNotConnected() {
    var _a;
    (_a = this.appKit) == null ? void 0 : _a.setCaipAddress(void 0, this.chainNamespace);
  }
  handleAuthIsConnected(preferredAccountType) {
    var _a, _b;
    const activeNamespace = (_a = this.appKit) == null ? void 0 : _a.getActiveChainNamespace();
    if (activeNamespace !== this.chainNamespace) {
      return;
    }
    (_b = this.appKit) == null ? void 0 : _b.setPreferredAccountType(preferredAccountType, this.chainNamespace);
  }
  handleAuthSetPreferredAccount(address, type) {
    ...
    (_a = this.appKit) == null ? void 0 : _a.setLoading(true);
    const chainId = NetworkUtil.caipNetworkIdToNumber((_c = (_b = this.appKit) == null ? void 0 : _b.getCaipNetwork()) == null ? void 0 : _c.id);
    (_d = this.appKit) == null ? void 0 : _d.setCaipAddress(`eip155:${chainId}:${address}`, this.chainNamespace);
    (_e = this.appKit) == null ? void 0 : _e.setStatus("connected", this.chainNamespace);
    (_f = this.appKit) == null ? void 0 : _f.setPreferredAccountType(type, this.chainNamespace);
    this.syncAccount({
      address
    }).then(() => {
      var _a2;
      return (_a2 = this.appKit) == null ? void 0 : _a2.setLoading(false);
    });
    (_g = this.appKit) == null ? void 0 : _g.setLoading(false);
  }
  async syncReownName(address) {
    var _a, _b, _c, _d;
    try {
      const registeredWcNames = await ((_a = this.appKit) == null ? void 0 : _a.getReownName(address));
      if (registeredWcNames == null ? void 0 : registeredWcNames[0]) {
        const wcName = registeredWcNames[0];
        (_b = this.appKit) == null ? void 0 : _b.setProfileName(wcName.name, this.chainNamespace);
      } else {
        (_c = this.appKit) == null ? void 0 : _c.setProfileName(null, this.chainNamespace);
      }
    } catch {
      (_d = this.appKit) == null ? void 0 : _d.setProfileName(null, this.chainNamespace);
    }
  }
  async syncAccount({ address, caipNetwork }) {
    var _a, _b, _c, _d, _e, _f, _g, _h;
    const currentCaipNetwork = caipNetwork || ((_a = this.appKit) == null ? void 0 : _a.getCaipNetwork());
    const preferredAccountType = (_b = this.appKit) == null ? void 0 : _b.getPreferredAccountType();
    const isEipNetwork = (currentCaipNetwork == null ? void 0 : currentCaipNetwork.chainNamespace) === ConstantsUtil.CHAIN.EVM;
    if (address) {
      if (isEipNetwork) {
        (_c = this.appKit) == null ? void 0 : _c.setPreferredAccountType(preferredAccountType, this.chainNamespace);
        this.syncConnectedWalletInfo();
        if (this.ethersConfig) {
          this.checkActiveProviders(this.ethersConfig);
        }
        if (currentCaipNetwork == null ? void 0 : currentCaipNetwork.explorerUrl) {
          (_d = this.appKit) == null ? void 0 : _d.setAddressExplorerUrl(`${currentCaipNetwork.explorerUrl}/address/${address}`, this.chainNamespace);
        }
        await Promise.all([
          this.syncProfile(address),
          (_e = this.appKit) == null ? void 0 : _e.setApprovedCaipNetworksData(this.chainNamespace)
        ]);
      }
    } else {
      (_f = this.appKit) == null ? void 0 : _f.resetWcConnection();
      (_g = this.appKit) == null ? void 0 : _g.resetNetwork();
      (_h = this.appKit) == null ? void 0 : _h.setAllAccounts([], this.chainNamespace);
    }
  }
  async syncProfile(address) {
    var _a, _b, _c, _d, _e, _f, _g;
    const caipNetwork = (_a = this.appKit) == null ? void 0 : _a.getCaipNetwork();
    try {
      const identity = await ((_b = this.appKit) == null ? void 0 : _b.fetchIdentity({
        address
      }));
      const name = identity == null ? void 0 : identity.name;
      const avatar = identity == null ? void 0 : identity.avatar;
      (_c = this.appKit) == null ? void 0 : _c.setProfileName(name, this.chainNamespace);
      (_d = this.appKit) == null ? void 0 : _d.setProfileImage(avatar, this.chainNamespace);
      if (!name) {
        await this.syncReownName(address);
      }
    } catch {
      if ((caipNetwork == null ? void 0 : caipNetwork.chainId) === 1) {
        const ensProvider = new InfuraProvider("mainnet");
        const name = await ensProvider.lookupAddress(address);
        const avatar = await ensProvider.getAvatar(address);
        if (name) {
          (_e = this.appKit) == null ? void 0 : _e.setProfileName(name, this.chainNamespace);
        } else {
          await this.syncReownName(address);
        }
        if (avatar) {
          (_f = this.appKit) == null ? void 0 : _f.setProfileImage(avatar, this.chainNamespace);
        }
      } else {
        await this.syncReownName(address);
        (_g = this.appKit) == null ? void 0 : _g.setProfileImage(null, this.chainNamespace);
      }
    }
  }
  async syncBalance(address, caipNetwork) {
    var _a, _b;
    const isExistingNetwork = (_a = this.appKit) == null ? void 0 : _a.getCaipNetworks().find((network) => network.id === caipNetwork.id);
    const isEVMNetwork = caipNetwork.chainNamespace === ConstantsUtil.CHAIN.EVM;
    if (caipNetwork && isExistingNetwork && isEVMNetwork) {
      ...
      if (jsonRpcProvider) {
        ...
        (_b = this.appKit) == null ? void 0 : _b.setBalance(formattedBalance, caipNetwork.currency, this.chainNamespace);
      }
    }
  }
  syncConnectedWalletInfo() {
    ...
    if (providerType === ConstantsUtil3.EIP6963_CONNECTOR_ID) {
      if (currentActiveWallet) {
        const currentProvider = this.EIP6963Providers.find((provider) => provider.info.name === currentActiveWallet);
        if (currentProvider) {
          (_a = this.appKit) == null ? void 0 : _a.setConnectedWalletInfo({ ...currentProvider.info }, this.chainNamespace);
        }
      }
    } else if (providerType === ConstantsUtil3.WALLET_CONNECT_CONNECTOR_ID) {
      const provider = ProviderUtil.getProvider("eip155");
      if (provider == null ? void 0 : provider.session) {
        (_c = this.appKit) == null ? void 0 : _c.setConnectedWalletInfo({
          ...provider.session.peer.metadata,
          name: provider.session.peer.metadata.name,
          icon: (_b = provider.session.peer.metadata.icons) == null ? void 0 : _b[0]
        }, this.chainNamespace);
      }
    } else if (providerType === ConstantsUtil3.COINBASE_SDK_CONNECTOR_ID) {
      const connector = (_d = this.appKit) == null ? void 0 : _d.getConnectors().find((c3) => c3.id === ConstantsUtil3.COINBASE_SDK_CONNECTOR_ID);
      (_f = this.appKit) == null ? void 0 : _f.setConnectedWalletInfo({ name: "Coinbase Wallet", icon: (_e = this.appKit) == null ? void 0 : _e.getConnectorImage(connector) }, this.chainNamespace);
    } else if (currentActiveWallet) {
      (_g = this.appKit) == null ? void 0 : _g.setConnectedWalletInfo({ name: currentActiveWallet }, this.chainNamespace);
    }
  }
  ...
  async switchNetwork(caipNetwork) {
    var _a, _b, _c, _d, _e, _f, _g, _h;
    async function requestSwitchNetwork(provider2) {
      var _a2, _b2;
      try {
        ...
        if (switchError.code === WcConstantsUtil.ERROR_CODE_UNRECOGNIZED_CHAIN_ID || switchError.code === WcConstantsUtil.ERROR_CODE_DEFAULT || ((_b2 = (_a2 = switchError == null ? void 0 : switchError.data) == null ? void 0 : _a2.originalError) == null ? void 0 : _b2.code) === WcConstantsUtil.ERROR_CODE_UNRECOGNIZED_CHAIN_ID) {
          await EthersHelpersUtil.addEthereumChain(provider2, caipNetwork);
        } else {
    ...
    if (provider) {
      switch (providerType) {
        case ConstantsUtil3.WALLET_CONNECT_CONNECTOR_ID:
          (_b = (_a = this.appKit) == null ? void 0 : _a.universalAdapter) == null ? void 0 : _b.networkControllerClient.switchCaipNetwork(caipNetwork);
          break;
        case ConstantsUtil3.INJECTED_CONNECTOR_ID:
        case ConstantsUtil3.EIP6963_CONNECTOR_ID:
        case ConstantsUtil3.COINBASE_SDK_CONNECTOR_ID:
          if (provider) {
            await requestSwitchNetwork(provider);
          }
          break;
        case ConstantsUtil3.AUTH_CONNECTOR_ID:
          if (this.authProvider) {
            try {
              (_c = this.appKit) == null ? void 0 : _c.setLoading(true);
              ...
              (_d = this.appKit) == null ? void 0 : _d.setCaipNetwork(caipNetwork);
              (_e = this.appKit) == null ? void 0 : _e.setCaipAddress(caipAddress, this.chainNamespace);
              (_f = this.appKit) == null ? void 0 : _f.setPreferredAccountType(preferredAccountType, this.chainNamespace);
              await this.syncAccount({ address });
              (_g = this.appKit) == null ? void 0 : _g.setLoading(false);
            } catch {
              throw new Error("Switching chain failed");
            } finally {
              (_h = this.appKit) == null ? void 0 : _h.setLoading(false);
            }
          }
          break;
        default:
  ...
  syncConnectors(config) {
    ...
    const w3mConnectors = [];
    if (config.injected) {
      const injectedConnectorType = PresetsUtil.ConnectorTypesMap[ConstantsUtil3.INJECTED_CONNECTOR_ID];
      if (injectedConnectorType) {
        w3mConnectors.push({
          id: ConstantsUtil3.INJECTED_CONNECTOR_ID,
          explorerId: PresetsUtil.ConnectorExplorerIds[ConstantsUtil3.INJECTED_CONNECTOR_ID],
          imageId: PresetsUtil.ConnectorImageIds[ConstantsUtil3.INJECTED_CONNECTOR_ID],
          imageUrl: (_b = (_a = this.options) == null ? void 0 : _a.connectorImages) == null ? void 0 : _b[ConstantsUtil3.INJECTED_CONNECTOR_ID],
          name: PresetsUtil.ConnectorNamesMap[ConstantsUtil3.INJECTED_CONNECTOR_ID],
    ...
    if (config.coinbase) {
      w3mConnectors.push({
        id: ConstantsUtil3.COINBASE_SDK_CONNECTOR_ID,
        explorerId: PresetsUtil.ConnectorExplorerIds[ConstantsUtil3.COINBASE_SDK_CONNECTOR_ID],
        imageId: PresetsUtil.ConnectorImageIds[ConstantsUtil3.COINBASE_SDK_CONNECTOR_ID],
        imageUrl: (_d = (_c = this.options) == null ? void 0 : _c.connectorImages) == null ? void 0 : _d[ConstantsUtil3.COINBASE_SDK_CONNECTOR_ID],
        name: PresetsUtil.ConnectorNamesMap[ConstantsUtil3.COINBASE_SDK_CONNECTOR_ID],
        type: "EXTERNAL",
        chain: this.chainNamespace
      });
    }
    (_e = this.appKit) == null ? void 0 : _e.setConnectors(w3mConnectors);
  }
  async syncAuthConnector(projectId, bypassWindowCheck = false) {
    ...
    if (bypassWindowCheck || typeof window !== "undefined") {
      ...
      (_b = this.appKit) == null ? void 0 : _b.setLoading(true);
      const isLoginEmailUsed = this.authProvider.getLoginEmailUsed();
      (_c = this.appKit) == null ? void 0 : _c.setLoading(isLoginEmailUsed);
  ...
  eip6963EventHandler(event) {
    ...
    if (event.detail) {
      ...
      const connectors = (_a = this.appKit) == null ? void 0 : _a.getConnectors();
      const existingConnector = connectors == null ? void 0 : connectors.find((c3) => c3.name === info.name);
      const coinbaseConnector = connectors == null ? void 0 : connectors.find((c3) => c3.id === ConstantsUtil3.COINBASE_SDK_CONNECTOR_ID);
      const isCoinbaseDuplicated = coinbaseConnector && event.detail.info.rdns === ConstantsUtil3.CONNECTOR_RDNS_MAP[ConstantsUtil3.COINBASE_SDK_CONNECTOR_ID];
      if (!existingConnector && !isCoinbaseDuplicated) {
        const type = PresetsUtil.ConnectorTypesMap[ConstantsUtil3.EIP6963_CONNECTOR_ID];
        if (type) {
          (_d = this.appKit) == null ? void 0 : _d.addConnector({
            id: ConstantsUtil3.EIP6963_CONNECTOR_ID,
            type,
            imageUrl: info.icon ?? ((_c = (_b = this.options) == null ? void 0 : _b.connectorImages) == null ? void 0 : _c[ConstantsUtil3.EIP6963_CONNECTOR_ID]),
            name: info.name,
            provider,
            info,
            chain: this.chainNamespace
  ...
  listenConnectors(enableEIP6963) {
    if (typeof window !== "undefined" && enableEIP6963) {
      ...
      window.addEventListener(ConstantsUtil3.EIP6963_ANNOUNCE_EVENT, handler);
      window.dispatchEvent(new Event(ConstantsUtil3.EIP6963_REQUEST_EVENT));
    }
  }
};
export {
