...
async function verifySignature({ address, message, signature, chainId, projectId }) {
  let isValid = Hf(address, message, signature);
  if (!isValid) {
    isValid = await Lf(address, message, signature, chainId, projectId);
  }
  return isValid;
}
...
var W3mConnectingSiweView = class W3mConnectingSiweView2 extends LitElement {
  ...
  async onSign() {
    ...
    EventsController.sendEvent({
      ...
      type: "track",
      properties: {
        network: ((_a = ChainController.state.activeCaipNetwork) == null ? void 0 : _a.id) || "",
    ...
    try {
      ...
      EventsController.sendEvent({
        ...
        type: "track",
        properties: {
          network: ((_b = ChainController.state.activeCaipNetwork) == null ? void 0 : _b.id) || "",
          isSmartAccount: AccountController.state.preferredAccountType === W3mFrameRpcConstants.ACCOUNT_TYPES.SMART_ACCOUNT
        }
      });
      return session;
      ...
      return EventsController.sendEvent({
        ...
        type: "track",
        properties: {
          network: ((_c = ChainController.state.activeCaipNetwork) == null ? void 0 : _c.id) || "",
          isSmartAccount
        }
      });
    } finally {
...
//# sourceMappingURL=exports-76LUB66L.js.map
